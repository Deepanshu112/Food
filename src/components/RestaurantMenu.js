...
const RestaurantMenu = () => {
  ...
  return (
    <div className="menu lg:mx-40 bg-customColor px-40 py-10 rounded-xl mt-10">
      ...
      <ul data-testid="menu" className="mx-3 bg-white rounded-xl px-10">
        {itemCards?.map((item) => (
          <li
            className="border-b-2 flex justify-between p-2 items-center duration-200"
          ...
          >
            ...
            <button
              data-testid="addBtn"
              className="p-1 md:p-2 m-1 md:m-2 rounded-md text-sm md:text-md shadow-lg text-greenColor bg-white border border-black-300 active:bg-blue-950 hover:scale-105"
