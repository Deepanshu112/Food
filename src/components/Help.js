...
const Section = (props) => {
  return (
    <div className=" my-4 border-b-2">
      ...
      {props.isVisible ? (
        <button
          className=" cursor-pointer border text-sm p-1 rounded-lg m-2 px-4"
...
const Help = () => {
 const [visibleSection, setVisibleSection]=useState("");
  ...
  return (
    <div className="bg-customColor mx-40 my-20 flex justify-center rounded-xl">
      <div className="w-3/5 h-auto p-10 bg-white my-5 rounded-xl">
